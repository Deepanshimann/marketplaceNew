...
const FrontPage = () => {
    return (
        <div className="portfolio-container relative  flex items-center justify-center py-4 pb-10 ">
            <div className="main mx-auto px-4 sm:px-6 lg:px-8">
                <div className="left text-left">
                    ...
                    <button className="mt-6 px-5 py-3 border rounded-full border-white font-gilroy font-bold text-white hover:bg-teal-500 hover:text-black hover:border-teal-500  transition duration-300">CHECK OUT WHAT IS NEW</button>
                </div>
                <div className="right">
